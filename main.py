...
btn_update_all = Button(window, text="Обновить все", bg="white", fg="blue", command=UpdateAll)
...
spin_left = Spinbox(window, from_=0, to=5, textvariable=myvar_set_left, width=3,
               font=Font(family='Helvetica', size=28, weight='bold'))
